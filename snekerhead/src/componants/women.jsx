...
import { filtercatN, filtercatwomen, filtertop, filtertopwomen, filterwomendata } from "../redux/all/action"
...
export const Women = () =>{
  ...
  const handleChangebrand = (event) => {
    ...
    dispatch(filtercatwomen(event.target.value))
  };
  const handleChangerate = (event) => {
    setRate(event.target.value);
    dispatch(filtertopwomen(event.target.value))
  };
    const dispatch=useDispatch();
   useEffect(()=>{
    dispatch(filterwomendata());
   },[]) 
...
return(
        <>
         <h1 style={{textAlign:"center",color:"black",fontSize:"30px",fontWeight:"700"}}>Women</h1>
