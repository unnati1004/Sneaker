...
import { filtercatN, filtertop, getdata } from "../redux/all/action"
...
export const All = () =>{
  ...
  const handleChangebrand = (event) => {
    setbrand(event.target.value);
      dispatch(filtercatN(event.target.value))
}
  const handleChangerate = (event) => {
    setRate(event.target.value);
    dispatch(filtertop(event.target.value))
...
return(
        <>
         <h1 style={{textAlign:"center",color:"black",fontSize:"30px",fontWeight:"700"}}>All Products</h1>
